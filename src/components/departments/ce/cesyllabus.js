            ...
            {course === "programmesug" && (
              <ul>
                <li>
                  ...
                  B.Tech Civil Engineering (Effective from 2022-2023 onward).pdf
                  </a>
                </li>
              </ul>
            )}
              ...
              <ul>
                <li>
                  <a href="https://drive.google.com/file/d/1jsKFA6qu4OGyIJSAf8Bp6Ow8Wz2houq0/view?usp=drivesdk">
                    Dual Degree (B.Tech (Civil Engineering) + M.Tech (Construction Technology Management)) Effective from 2022-2023 onward.pdf
                  </a>
                </li>
              </ul>
            )}
